...
class SecurityReferenceLayersEngine {
    static async loadSecurityTests(filePath) {
        const results = [];
    ...
    static async searchSecurityTests(query, layer) {
        try {
    ...
    try {
        switch (request.params.name) {
            case "security.search_tests": {
                const { query, layer } = request.params.arguments;
