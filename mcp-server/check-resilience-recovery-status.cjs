...
async function checkResilienceRecoveryStatus() {
    console.log("🔍 Status Check for Resilience/Recovery Tests File");
    console.log("================================================");
    
    try {
        // Path to the resilience/recovery file
        const filePath = path.join(__dirname, "..", "DEX-OS-V2", ".reference", "layers", "gold", "5. resilience_recovery_with_dsa_types.csv");
...
console.log("🔍 Resilience/Recovery File Status Checker");
console.log("========================================");
checkResilienceRecoveryStatus().catch(console.error);