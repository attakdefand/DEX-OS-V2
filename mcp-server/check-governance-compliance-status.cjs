...
async function checkGovernanceComplianceStatus() {
    console.log("🔍 Status Check for Governance/Compliance Tests File");
    console.log("================================================");
    
    try {
        // Path to the governance/compliance file
        const filePath = path.join(__dirname, "..", "DEX-OS-V2", ".reference", "layers", "gold", "6. governance_compliance_full_with_dsa_types.csv");
...
console.log("🔍 Governance/Compliance File Status Checker");
console.log("==========================================");
checkGovernanceComplianceStatus().catch(console.error);