...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("  Test 1 executed: {}", coverage_tracker.is_test_executed(&test_names[0]));
    println!("  Test 100 executed: {}", coverage_tracker.is_test_executed(&test_names[99]));
    ...
    if test_names.len() > 500 {
        println!("  Test 600 executed: {}", coverage_tracker.is_test_executed(&test_names[599]));
    }
