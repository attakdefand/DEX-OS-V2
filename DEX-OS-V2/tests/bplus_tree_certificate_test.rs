...
fn test_bplus_tree_certificate_storage() {
    ...
    let result = cert_manager.add_certificate(cert1.clone());
    ...
    let result = cert_manager.revoke_certificate("cert1");
    assert!(result.is_err());
    match result {
    ...
    let result = cert_manager.revoke_certificate("nonexistent");
    assert!(result.is_err());
    match result {
