//! Standalone test for the BloomFilter implementation
...
fn main() {
    println!("Running standalone BloomFilter test...");
    
    let mut filter = BloomFilter::new(100, 3);
    filter.add("test");
    
    println!("Contains 'test': {}", filter.might_contain("test"));
    println!("Contains 'nonexistent': {}", filter.might_contain("nonexistent"));
    ...
    println!("Contains 'item1': {}", filter.might_contain("item1"));
    println!("Contains 'item2': {}", filter.might_contain("item2"));
    println!("Contains 'item3': {}", filter.might_contain("item3"));
    println!("Contains 'item4': {}", filter.might_contain("item4"));
