...
impl ObservabilityManager {
    ...
    pub fn register_histogram(
        ...
        self.histograms
            .insert(name, Histogram::new(description, buckets));
        Ok(())
    }
    ...
    pub fn get_histogram_snapshot(
        &self,
        name: &str,
    ) -> Result<HistogramSnapshot, ObservabilityError> {
        if let Some(histogram) = self.histograms.get(name) {
    ...
    pub fn get_metrics_snapshot(&self) -> MetricsSnapshot {
        ...
        for (name, counter) in &self.counters {
            counters.insert(
                name.clone(),
                (counter.get_value(), counter.description.clone()),
            );
        }
...
mod tests {
    ...
    fn test_counter_metrics() {
        ...
        assert!(manager
            .register_counter(
                ...
                "Another test counter".to_string()
            )
            .is_err());
    ...
    fn test_metrics_snapshot() {
        ...
        // Register metrics
        manager
            .register_counter("counter1".to_string(), "Test counter".to_string())
            .unwrap();
        manager
            .register_gauge("gauge1".to_string(), "Test gauge".to_string())
            .unwrap();
        manager
            .register_histogram(
    ...
    fn test_concurrent_access() {
        ...
        assert_eq!(
            manager
                .lock()
                .unwrap()
                .get_counter_value("concurrent_counter")
                .unwrap(),
            1000
        );
    }
